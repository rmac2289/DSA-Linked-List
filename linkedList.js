...
linkedList.insertAtHead('Apollo');
linkedList.insertAtTail('Boomer');
linkedList.insertAtTail('Helo');
linkedList.insertAtTail('Husker');
linkedList.insertAtTail('Starbuck');
linkedList.insertAtTail('Tauhida');
linkedList.printList();
linkedList.insertBefore('Boomer', 'Athena');
linkedList.insertAfter('Helo', 'Hotdog');
linkedList.insertAtIndex(2, 'Kat');
linkedList.printList();
